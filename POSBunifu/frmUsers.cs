...
namespace POSBunifu
{
    public partial class frmUsers : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    MessageBox.Show("Duplicate value, please try again")
            //}
            //else

            if (txtPassword.Text==(user.sqlselect = "SELECT Pass FROM tbluser") && (user.sqlselect= "select User_name from tbluser")== txtUsername.Text)
            {
                MessageBox.Show("Duplicate value, please try again");
            }
